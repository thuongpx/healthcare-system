...
import { getDoctorById } from "@/utils/services/appointment";
import React from "react";
import { FaBriefcaseMedical, FaCalendarDay } from "react-icons/fa";
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="bg-blue-50 py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-x-4">
              ...
              <div className="mt-4 items-center justify-between gap-2 flex-wrap text-xs font-medium">
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-8 flex gap-4 flex-wrap text-sm text-gray-500">
            <Link
              ...
              className="p-3 rounded-md bg-yellow-600 hover:underline"
            >
              Doctor Appointments
            </Link>
